(define (domain warehouse)
   ...
   (:action robotMove
      ...
      :effect (and (not (at ?r ?l1)) (no-robot ?l1) (not (no-robot ?l2)) (at ?r ?l2))
   )
   (:action pickup
   ...
   (:action robotMoveWithPallette
      ...
      :precondition (and (at ?r ?l1) (at ?p ?l1) (has ?r ?p) (not (free ?r)) (no-pallette ?l2) (no-robot ?l2) (connected ?l1 ?l2))
      :effect (and (not (at ?r ?l1))(not (at ?p ?l1))(no-pallette ?l1)(no-robot ?l1)(not (no-pallette ?l2))(not (no-robot ?l2))(at ?r ?l2)(at ?p ?l2))
   )
   ...
   (:action completeShipment
      ...
      :effect (and (not (started ?s)) (not (packing-at ?s ?l)) (complete ?s) (available ?l))
   )
)
